...
/* 
 * Página que muestra los datos de la ciudad seleccionada en modificarCiudad1
 * //y permite modificarlos en la bbdd
 */
...
//Recogemos la ciudad seleccionado del post (código postal)
$cp=$_POST['ciudad'];
...
echo"Codigo postal: <input type='text' name='cpnuevo' value='$postalcode'>";
